...
RSpec.describe "Posts page", type: :feature do
  before :each do
    ...
    @post1 = @user1.posts.create!(title: "testing1", text: "i am here to write test cases 1", comments_counter: 0, likes_counter: 0)
    @post2 = @user1.posts.create!(title: "testing2", text: "i am here to write test cases 2", comments_counter: 0, likes_counter: 0)
    @post3 = @user1.posts.create!(title: "testing3", text: "i am here to write test cases 3", comments_counter: 0, likes_counter: 0)
    @post4 = @user1.posts.create!(title: "testing4", text: "i am here to write test cases 4", comments_counter: 0, likes_counter: 0)
